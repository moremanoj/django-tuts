...
urlpatterns = [
    ...
    path('print/<int:pk>', views.GeneratePDF.as_view(), name='print-pdf'),
    ...
    path('jobs/', views.JobListView.as_view(), name='garage-jobs'),
    path('jobs/<int:pk>', views.JobUpdateView.as_view(), name='garage-jobs-update'),
]
